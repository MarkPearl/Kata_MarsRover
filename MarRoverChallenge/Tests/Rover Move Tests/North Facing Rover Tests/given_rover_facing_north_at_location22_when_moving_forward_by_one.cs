...
{
	public class given_rover_facing_north_at_location_2_2_when_moving_forward_by_one : RoverTestsBase
	{
		Establish context = () =>
		{			
		...
		It should_be_at_position_2_3 = () =>
		{
			Rover.RoverPosition().ShouldEqual(Position.SepecificCoord(2,3));
		};
	}
}